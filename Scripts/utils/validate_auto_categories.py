...
def _run_report(
    ...
    surprise_write = top_surprises.rename(columns={"category": "auto_category"})
    surprise_write = surprise_write[
        [c for c in surprise_out_cols if c in surprise_write.columns]
    ]
