...
def detect_swt(ecg: np.ndarray, fs: float, refractory_ms: float = 250.0) -> np.ndarray:
    ...
    At 256 Hz these levels capture 8-32 Hz — the core QRS energy band.
    ...
    # At 256 Hz: level 3 detail ≈ 16-32 Hz, level 4 detail ≈ 8-16 Hz
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument("--fs", type=float, default=256.0,
                   help="Sampling rate Hz (default: 256)")
