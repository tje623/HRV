...
def _build_parser() -> argparse.ArgumentParser:
    ...
    p_fuse.add_argument("--alpha", type=float, default=0.5, help="Blend weight for tabular (default 0.5)")
    p_fuse.add_argument("--threshold", type=float, default=0.5, help="Decision threshold (default 0.5)")
